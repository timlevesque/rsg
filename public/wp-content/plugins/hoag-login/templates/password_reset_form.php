<div id="password-reset-form" class="widecolumn">
    ...
    <form name="resetpassform" id="resetpassform" action="<?php echo site_url( 'wp-login.php?action=resetpass' ); ?>" method="post" autocomplete="off">
        ...
        <div class="form-group text-left">
            ...
            <input type="password" name="pass1" id="pass1" class="form-control input"  size="20" value="" autocomplete="off" />
        </div>
        <div class="form-group text-left">
        ...
        <p class="description small"><?php echo wp_get_password_hint(); ?></p>
         
        <p class="resetpass-submit">
            <input type="submit" name="submit" id="resetpass-button"
                   class="btn btn-primary" value="<?php _e( 'Reset Password', 'personalize-login' ); ?>" />
        </p>
    </form>
</div>