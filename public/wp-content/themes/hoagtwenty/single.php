...
<header class="px-0 w-100 single-post-top-block entry-header container-sm >">
			...
			<?php
					the_title( '<h1 class="entry-title text-secondary">', '</h1>' );
					?>
            <span class="text-primary"><?php echo $city;?></span>
            <?php 
            if(has_post_thumbnail( )):?>
            <div class="img-16-90 m-h500 m-h300-sm my-4"><?php the_post_thumbnail('', array('class' => 'h-100 img-fluid img-flex ie-flexfix')); ?> </div>
            <?php endif; ?>
